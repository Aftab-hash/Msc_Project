...
! function (a) {
    a.fn.jvenn = function (b) {
        function h(a, b, c, d, e, f, h) {
            g.beginPath(), g.save(), g.translate(a, b), g.rotate(f * Math.PI / 180), g.scale(d, e), g.arc(0, 0, c, 0, 2 * Math.PI), g.fillStyle = h, g.fill(), g.restore()
        }

        function j(a, b, c, d, e, f, h) {
            g.beginPath(), g.save(), g.moveTo(a, b), g.lineTo(c, d), g.lineTo(e, f), g.fillStyle = h, g.fill(), g.restore()
        }

        function k(a, b, c, d, e) {
            g.lineWidth = 1, g.beginPath(), g.moveTo(a, b), g.lineTo(c, d), g.strokeStyle = e, g.stroke()
        }

        function l(a, b, c, d, e, f, h) {
            g.beginPath(), g.save(), g.translate(a, b), g.rotate(f * Math.PI / 180), g.scale(d, e), g.arc(0, 0, c, 0, 2 * Math.PI), g.lineWidth = 3, g.strokeStyle = h, u(h) >= .6 && (g.fillStyle = s(h, .1), g.fill()), g.stroke(), g.restore()
        }
        ...
        function p(a, b, c, d, e) {
            var f = 10;
            g.beginPath(), g.moveTo(a + f, b), g.lineTo(a + c - f, b), g.quadraticCurveTo(a + c, b, a + c, b + f), g.lineTo(a + c, b + d - f), g.quadraticCurveTo(a + c, b + d, a + c - f, b + d), g.lineTo(a + f, b + d), g.quadraticCurveTo(a, b + d, a, b + d - f), g.lineTo(a, b + f), g.quadraticCurveTo(a, b, a + f, b), g.closePath(), g.lineWidth = 3, g.strokeStyle = e, u(e) >= .6 && (g.fillStyle = s(e, .1), g.fill()), g.stroke()
        }

        function q(a, b, c, d, e) {
            a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.closePath(), a.stroke()
        }

        function r(a, b, c, d, e, f, g) {
            a.beginPath(), a.rect(b, c, d, e), a.closePath(), a.lineWidth = .75, a.shadowColor = "rgba(0,0,0, 0.4)", a.shadowBlur = 7, a.shadowOffsetX = 2, a.shadowOffsetY = -2, a.strokeStyle = g, a.stroke(), a.fillStyle = f, a.fill()
        }
        ...
        function w(b) {
            for (var c = "rgba(0,0,0, 0.7)", e = 120, f = 70, h = 415, i = 20, k = (370 - b * i) / b, l = 265, m = E(), n = new Array, o = 0, p = 0; p < b; p++) o = Math.max(o, m[p]);
            for (var p = 0; p < b; p++) n.push(m[p] / o * (e - 50));
            g.fillStyle = "#000", g.font = "italic 10pt Arial", g.textAlign = "center", g.fillText("Size of each list", 250, h + 27), g.font = "normal 8pt Arial", g.textAlign = "right", g.fillText(0, 45, h + e + 2), g.fillText(o / 2, 45, h + (e + 55) / 2), g.fillText(o, 45, h + 54), g.textAlign = "left";
            for (var p = 0; p < b; p++) r(g, f + p * k + p * i, h + e - n[p], k, n[p], s(d.colors[p], .5), d.colors[p]), e - n[p] + 15 <= e - 10 ? (g.textAlign = "right", g.fillStyle = "white", g.fillText(m[p], k + 65 + p * k + p * i, h + e - n[p] + 15)) : (g.textAlign = "right", g.fillText(m[p], k + 65 + p * k + p * i, h + e - n[p] - 10)), l = p % 2 && b > 2 ? h + e + 25 : h + e + 15, g.fillStyle = "#000", g.textAlign = "center", g.fillText(a("#" + N + "-label" + (p + 1)).html(), f + p * k + p * i + k / 2, l, 200), g.strokeStyle = c, g.lineWidth = .4, q(g, f + p * k + p * i + k / 2, h + e, f + p * k + p * i + k / 2, h + e + 5);
            g.lineWidth = 1, g.strokeStyle = c, q(g, 50, h + e, 50, h + 35), q(g, 50, h + e, 450, h + e), g.lineWidth = .4, q(g, 47, h + (e + 48) / 2, 53, h + (e + 48) / 2), q(g, 47, h + 50, 53, h + 50), j(50, h + 25, 46, h + 35, 54, h + 35, c), j(460, h + e, 450, h + e - 4, 450, h + e + 4, c);
            var t = D(),
                u = new Array;
            i = 2, f = 60, h += e + 50;
            for (var v = 390 + i, w = 0, p = 0; p < b; p++) w += t[p];
            for (var p = 0; p < b; p++) u.push(t[p] / w * v);
            g.font = "italic 10pt Arial", g.textAlign = "center", g.fillText("Number of elements: specific (1) or shared by 2, 3, ... lists", 250, h), g.font = "normal 8pt Arial";
            ...
            g.lineWidth = 1, g.strokeStyle = c, q(g, 50, h + 40, 460, h + 40)
        }
        ...
        function B(b, c) {
            ...
            a("*[id^=" + N + "-label]").each(function () {
                g += '<div id="' + N + "-item-" + e + '" name="' + a(this).text() + '" class="leg-items" style="opacity:0.5; background-color:' + a(this).css("color") + f + '">', g += '<span style="background-color:white; margin-left:0px; padding:0px 2px 0px 2px; transition: margin-left .3s ease-in-out;">off</span></div>', e += 1, e > c && (f = ";display:none")
            }), g += "</div>", $t.append(g), a("*[id^=" + N + "-item]").hover(function () {
                a(this).css("opacity", .75), a(this).css("box-shadow", "0px 0px 8px 1px lightgrey")
            }, function () {
                "off" === a(this).children("span").text() && a(this).css("opacity", .5), a(this).css("box-shadow", "none")
            }), a("*[id^=" + N + "-item]").click(function () {
                var b = null;
                b = "off" === a(this).children("span").text() ? L(a(this).attr("name")) : K(a(this).attr("name")), null != d.searchInput && (d.searchInput.val(""), null != d.searchStatus && d.searchStatus.text("")), v(), "edwards" == d.displayMode ? A(c) : z(c), d.displayStat && w(c), b != N + "-resultC000000" && a("#" + N + "-" + b).show()
            })
        }
        ...
        function D() {
            ...
            return a("*[id^=" + N + "-resultC]").each(function () {
                for (var c = 0, d = N.length + 7; d < a(this).attr("id").length; d++) c += "1" == a(this).attr("id").substring(d + 1, d + 2);
                var e = a(this).text();
                "?" == e && (e = a(this).children("span").attr("title")), b[c - 1] += parseInt(e)
            }), b
        }
        ...
        function E() {
            ...
            return a("*[id^=" + N + "-resultC]").each(function () {
                for (var c = N.length + 7; c < a(this).attr("id").length; c++)
                    if ("1" == a(this).attr("id").substring(c + 1, c + 2)) {
                        var d = a(this).text();
                        "?" == d && (d = a(this).children("span").attr("title")), b[c - (N.length + 7)] += parseInt(d)
                    }
            }), b
        }

        function F(b) {
            b.A && a("#" + N + "-resultC100000").html(b.A), b.B && a("#" + N + "-resultC010000").html(b.B), b.C && a("#" + N + "-resultC001000").html(b.C), b.D && a("#" + N + "-resultC000100").html(b.D), b.E && a("#" + N + "-resultC000010").html(b.E), b.F && a("#" + N + "-resultC000001").html(b.F), b.AB && a("#" + N + "-resultC110000").html(b.AB), b.AC && a("#" + N + "-resultC101000").html(b.AC), b.AD && a("#" + N + "-resultC100100").html(b.AD), b.AE && a("#" + N + "-resultC100010").html(b.AE), b.AF && a("#" + N + "-resultC100001").html(b.AF), b.BC && a("#" + N + "-resultC011000").html(b.BC), b.BD && a("#" + N + "-resultC010100").html(b.BD), b.BE && a("#" + N + "-resultC010010").html(b.BE), b.BF && a("#" + N + "-resultC010001").html(b.BF), b.CD && a("#" + N + "-resultC001100").html(b.CD), b.CE && a("#" + N + "-resultC001010").html(b.CE), b.CF && a("#" + N + "-resultC001001").html(b.CF), b.DE && a("#" + N + "-resultC000110").html(b.DE), b.DF && a("#" + N + "-resultC000101").html(b.DF), b.EF && a("#" + N + "-resultC000011").html(b.EF), b.ABC && a("#" + N + "-resultC111000").html(b.ABC), b.ABD && a("#" + N + "-resultC110100").html(b.ABD), b.ABE && a("#" + N + "-resultC110010").html(b.ABE), b.ABF && a("#" + N + "-resultC110001").html(b.ABF), b.ACD && a("#" + N + "-resultC101100").html(b.ACD), b.ACE && a("#" + N + "-resultC101010").html(b.ACE), b.ACF && a("#" + N + "-resultC101001").html(b.ACF), b.ADE && a("#" + N + "-resultC100110").html(b.ADE), b.ADF && a("#" + N + "-resultC100101").html(b.ADF), b.AEF && a("#" + N + "-resultC100011").html(b.AEF), b.BCD && a("#" + N + "-resultC011100").html(b.BCD), b.BCE && a("#" + N + "-resultC011010").html(b.BCE), b.BCF && a("#" + N + "-resultC011001").html(b.BCF), b.BDE && a("#" + N + "-resultC010110").html(b.BDE), b.BDF && a("#" + N + "-resultC010101").html(b.BDF), b.BEF && a("#" + N + "-resultC010011").html(b.BEF), b.CDE && a("#" + N + "-resultC001110").html(b.CDE), b.CDF && a("#" + N + "-resultC001101").html(b.CDF), b.CEF && a("#" + N + "-resultC001011").html(b.CEF), b.DEF && a("#" + N + "-resultC000111").html(b.DEF), b.ABCD && a("#" + N + "-resultC111100").html(b.ABCD), b.ABCE && a("#" + N + "-resultC111010").html(b.ABCE), b.ABCF && a("#" + N + "-resultC111001").html(b.ABCF), b.ABDE && a("#" + N + "-resultC110110").html(b.ABDE), b.ABDF && a("#" + N + "-resultC110101").html(b.ABDF), b.ACDE && a("#" + N + "-resultC101110").html(b.ACDE), b.ACDF && a("#" + N + "-resultC101101").html(b.ACDF), b.BCDE && a("#" + N + "-resultC011110").html(b.BCDE), b.BCDF && a("#" + N + "-resultC011101").html(b.BCDF), b.CDEF && a("#" + N + "-resultC001111").html(b.CDEF), b.BDEF && a("#" + N + "-resultC010111").html(b.BDEF), b.BCEF && a("#" + N + "-resultC011011").html(b.BCEF), b.ADEF && a("#" + N + "-resultC100111").html(b.ADEF), b.ACEF && a("#" + N + "-resultC101011").html(b.ACEF), b.ABEF && a("#" + N + "-resultC110011").html(b.ABEF), b.ABCDE && a("#" + N + "-resultC111110").html(b.ABCDE), b.ABCDF && a("#" + N + "-resultC111101").html(b.ABCDF), b.ABCEF && a("#" + N + "-resultC111011").html(b.ABCEF), b.ABDEF && a("#" + N + "-resultC110111").html(b.ABDEF), b.ACDEF && a("#" + N + "-resultC101111").html(b.ACDEF), b.BCDEF && a("#" + N + "-resultC011111").html(b.BCDEF), b.ABCDEF && a("#" + N + "-resultC111111").html(b.ABCDEF)
        }
        ...
        function G() {
            ...
            a("*[id^=" + N + "-resultC]").each(function () {
                this.listnames = new Array;
                for (var b = N.length + 7; b < a(this).attr("id").length; b++)
                    if ("1" == a(this).attr("id").substring(b + 1, b + 2)) try {
                ...
                if (d.series[0].hasOwnProperty("data")) {
                    for (var c = "", b = N.length + 7; b < a(this).attr("id").length; b++) "1" == a(this).attr("id").substring(b + 1, b + 2) && (b == N.length + 7 ? c += "A" : b == N.length + 8 ? c += "B" : b == N.length + 9 ? c += "C" : b == N.length + 10 ? c += "D" : b == N.length + 11 ? c += "E" : b == N.length + 12 && (c += "F"));
                    this.list = d.series[0].data[c], d.disableClick || (a(this).mouseover(function () {
                        a(this).addClass("number-over")
        ...
        function I(a, b, c, d, e, f, g, h, i) {
            return i ? (b = parseInt(b.replace("px", "")) + 20, c = parseInt(c.replace("px", "")) + 14) : (b = parseInt(b.replace("px", "")) + 5, c = parseInt(c.replace("px", "")) + 14), '<text fill="' + d + '" fill-opacity="' + e + '" stroke="none" font-family="' + f + '" font-size="' + g + '"pt font-style="normal" font-weight="' + h + '" text-decoration="none" x="' + b + '"pt y="' + c + '"pt text-anchor="middle" dominant-baseline="alphabetic">' + a + "</text>"
        }

        function J(b, c, d) {
            $t = b;
            var h = '<div id="' + N + '-module-export" style="position: relative; left:475px; top: -' + (418 + c) + 'px; width: 25px; height: 20px;">';
            h += '<a id="' + N + '-data-export" href="" download="" style="display:none;"></a>', h += '<canvas id="' + N + '-canvasExport" style="border:1px solid white" width="25" height="20"></canvas>', h += '<div id="' + N + '-export-menu" style="position: relative;width:150px; height:30px; display:none; right:123px; top:-4px;">', h += '<div style="box-shadow: 3px 3px 10px rgb(136, 136, 136); border: 1px solid rgb(160, 160, 160); background: none repeat scroll 0% 0% rgb(255, 255, 255);padding: 5px 0px;">', h += '<div id="' + N + '-format-png" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download PNG image</div>', h += '<div id="' + N + '-format-svg" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download SVG image</div>', "list" == d && (h += '<div id="' + N + '-format-csv" style="padding: 0px 10px; background: none repeat scroll 0% 0% transparent; color: rgb(48, 48, 48); font-size: 12px;">Download CSV lists</div>'), h += "</div>", h += "</div>", h += "</div>", $t.append(h);
            var j = a("#" + N + "-canvasExport")[0],
                k = j.getContext("2d");
            for (i = 0; i < 3; i++) k.lineWidth = 3, k.beginPath(), k.lineCap = "round", k.moveTo(5, 5 + 5.2 * i), k.lineTo(20, 5 + 5.2 * i), k.strokeStyle = "#666", k.stroke();
            var l = a("#" + N + "-export-menu"),
                m = a("#" + N + "-canvasExport").css("background");
            a("#" + N + "-format-png").click(function (b) {
                a("#" + N + "-canvasExport").css("background", m), a("#" + N + "-canvasExport").css("border-color", "white"), a("#" + N + "-canvasExport").hover(function () {
                    a(this).css("background", "linear-gradient(to bottom, white, #AECEFF) repeat scroll 0 0 transparent"), a(this).css("border", "1px solid #6688AA"), a(this).css("border-radius", "3px")
                }, function () {
                    a(this).css("background", m), a(this).css("border-color", "white")
                }), l.hide();
                var c = document.createElement("canvas");
                export_ctx = c.getContext("2d"), c.width = e, c.height = f;
                var d = document.createElement("img"),
                    h = a("<div></div>");
                h.append(g.getSerializedSvg(!0)), a("[id^=" + N + "-resultC]").each(function () {
                ...
                }), d.setAttribute("src", "data:image/svg+xml;base64," + window.btoa(h.html())), d.setAttribute("height", "700px"), d.setAttribute("width", "500px"), d.onload = function () {
                    export_ctx.drawImage(d, 0, 0);
                    var b = c.toDataURL("image/png");
                    a("#" + N + "-data-export").attr("href", b), a("#" + N + "-data-export").attr("download", "jVenn_chart.png"), a("#" + N + "-data-export")[0].click()
                }
                ...
                var c = a("<div></div>");
                c.append(g.getSerializedSvg(!0)), a("[id^=" + N + "-resultC]").each(function () {
                ...
                var d = "data:image/svg+xml;base64," + window.btoa(c.html()),
                    e = encodeURI(d);
                a("#" + N + "-data-export").attr("href", e), a("#" + N + "-data-export").attr("download", "jVenn_chart.svg"), a("#" + N + "-data-export")[0].click()
                ...
                a("*[id^=" + N + "-resultC]").each(function () {
                    if (!this.empty) {
                        ...
                        b.indexOf(",") >= 0 && (d = !0, b = b.replace(/,/g, "_")), a.push(b);
                        for (var e = 0; e < this.list.length; e++) b = this.list[e], this.list[e].indexOf(",") >= 0 && (d = !0, b = this.list[e].replace(/,/g, "_")), a.push(b);
                        c.push(a)
                    }
                });
                ...
                var f = encodeURI(e);
                a("#" + N + "-data-export").attr("href", f), a("#" + N + "-data-export").attr("download", "jVenn.csv"), a("#" + N + "-data-export")[0].click()
            }), a("#" + N + "-canvasExport").click(function (b) {
                a(this).css("background", "linear-gradient(to bottom, #AECEFF, white) repeat scroll 0 0 transparent"), a(this).css("border", "1px solid #6688AA"), a("#" + N + "-canvasExport").unbind("mouseenter mouseleave"), l.show(), l.is(":visible") && a(document).mouseup(function (b) {
                ...
                a("div[id^=" + N + "-format-]").hover(function () {
                    a(this).css("background", "rgba(69,114,165,0.75)"), a(this).css("color", "white")
                }, function () {
                    a(this).css("background", c), a(this).css("color", "")
                })
        ...
        function K(b, c) {
            ...
            a("*[id^=" + N + "-label]").each(function () {
                if (a(this).html() == b) {
                    a(this).css("opacity", .1), a(this).removeClass("is-selected");
                    var c = a(this).attr("id");
                    d = c.charAt(c.length - 1)
                }
            }), legend_button = a("#" + N + "-item-" + d), legend_button.children("span").css("margin-left", "0px"), legend_button.css("opacity", .5), legend_button.children("span").text("off");
        ...
        function L(b) {
            ...
            a("*[id^=" + N + "-label]").each(function () {
                if (a(this).html() == b) {
                    a(this).css("opacity", .6), a(this).addClass("is-selected");
                    var d = a(this).attr("id");
                    c = d.charAt(d.length - 1)
                } else a(this).hasClass("is-selected") || a(this).css("opacity", .1)
            }), legend_button = a("#" + N + "-item-" + c), legend_button.children("span").css("margin-left", "13px"), legend_button.css("opacity", .75), legend_button.css("color", "black"), legend_button.children("span").text("on");
        ...
        function M(b, c) {
            ...
            if (a("*[id^=" + N + "-label]").each(function () {
                ...
                if (g <= 1)
                    for (var h in e) f = "selected" == e[h] ? L(h) : K(h, !1);
                else
                    for (var h in e) f = K(h)
            }
            null != d.searchStatus && ("" == b || c > b.length ? d.searchStatus.text("") : 0 == g ? d.searchStatus.text("not found") : 1 == g ? d.searchStatus.text("found") : g > 1 && d.searchStatus.text("ambiguous")), v(), "edwards" == d.displayMode ? A(H()[1]) : z(H()[1]), d.displayStat && w(H()[1]), f != N + "-resultC000000" && a("#" + f).show()
        }
        var c = {
                series: [{
                    name: "Actors",
        ...
        return this.each(function () {
            ...
            "list" == k[0] ? C() : "count" == k[0] && G(), null != d.searchInput && d.searchInput.keyup(function () {
                ...
                if (null != d.searchInput && "" != d.searchInput.val() && (c = !0), !b && !c && "" !== a(this).text()) {
                    ...
                    }), v(), "edwards" == d.displayMode ? A(k[1]) : z(k[1]), d.displayStat && w(k[1])
                }
            }, function () {
                var b = !1;
                a("*[id^=" + N + "-item]").each(function () {
